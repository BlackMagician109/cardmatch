...
func _ready() -> void:
	...
	GameManager.currentLevel = 11 #Change This
	maxCards = 12 #Change This
	var totalCards = maxCards
	levelCards = [card, card_2, card_3, card_4, card_5, card_6, card_7, card_8, card_9, card_10, card_11, card_12] #Change This
