...
func _ready() -> void:
	...
	GameManager.currentLevel = 27 #Change This
	maxCards = 18 #Change This
	var totalCards = maxCards
	levelCards = [card, card_2, card_3, card_4, card_5, card_6, card_7, card_8, card_9, card_10, card_11, card_12, card_13, card_14, card_15, card_16, card_17, card_18] #Change This
